...
async def test_calculate_center_of_mass():
    ...
    com = await zoo_calculate_center_of_mass(file_path=path, unit_length="mm")
...
async def test_calculate_surface_area():
    ...
    surface_area = await zoo_calculate_surface_area(file_path=path, unit_area="mm2")
...
async def test_calculate_volume():
    ...
    volume = await zoo_calculate_volume(file_path=path, unit_vol="cm3")
